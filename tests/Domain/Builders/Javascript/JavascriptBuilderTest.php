...
jQuery(document).ready(function ($) {
    ...
    const fooUrl = $('#tests_form_foo').data('autocomplete-url');
    const postIdUrl = $('#tests_form_postId').data('autocomplete-url');

    $('#tests_form_foo').select2({
        theme: 'bootstrap4',
